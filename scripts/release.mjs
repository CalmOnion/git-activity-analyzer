...
execSync('zip ./releases/win-x64-gaa.zip ./releases/win-x64/gaa.exe', { stdio: 'inherit' });
execSync('zip ./releases/linux-x64-gaa.zip ./releases/linux-x64/gaa', { stdio: 'inherit' });
execSync('zip ./releases/osx-arm64-gaa.zip ./releases/osx-arm64/gaa', { stdio: 'inherit' });
